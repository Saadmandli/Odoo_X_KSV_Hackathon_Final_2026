...
const TEST_ACCOUNTS = [
  ...
  { name: "Shrey Naik", email: "shrey@northbridge.in", password: "admin123", note: "Administrator" },
];
            ...
            {TEST_ACCOUNTS.map(({ name, email, password, note }) => {
              ...
              return (
                <button
                  ...
                  className={`group relative flex flex-col justify-between rounded-xl border p-3 text-left transition-all duration-200 hover:-translate-y-0.5 hover:scale-[1.01] hover:shadow-xs active:scale-[0.99] cursor-pointer ${
                    isSelected
                ...
                >
                  ...
                  <span className="mt-1 text-[11px] font-medium text-slate-500 group-hover:text-emerald-800">
                    {note}
                  </span>
                </button>
              );
